...
namespace GiftGroup\GeoPage\Block\Adminhtml\StatePage;
...
class GenerateSitemap implements ButtonProviderInterface
{
    ...
    {
        return __('This will generate sitemap for all the stores and it will be saved in pub/sitemaps/ folder. So you can get the sitemap as {siteurl}/sitemaps/sitemap_state_pages_{storecode}.xml');
    }
}
