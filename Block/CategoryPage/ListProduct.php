...
namespace GiftGroup\GeoPage\Block\CategoryPage;
...
class ListProduct extends CoreListProduct implements IdentityInterface
{
    ...
    protected $categoryPageViewRegistry;
    ...
    public function __construct(
        ...
        CategoryPageView $categoryPageViewRegistry,
        ...
        $this->categoryPageViewRegistry = $categoryPageViewRegistry;
    ...
    {
        $categoryPage = $this->categoryPageViewRegistry->getCategoryPage();
        $collection = $this->productCollectionFactory->create();
        $collection->addAttributeToSelect('*');
        $collection->addFieldToFilter('entity_id', ['in' => $categoryPage->getProductIds()]);
