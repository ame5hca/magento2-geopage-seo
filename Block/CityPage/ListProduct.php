...
class ListProduct extends CoreListProduct implements IdentityInterface
{
    ...
    protected $cityPageViewRegistry;
    ...
    public function __construct(
        ...
        CityPageView $cityPageViewRegistry,
        ...
        $this->cityPageViewRegistry = $cityPageViewRegistry;
    ...
    {
        $cityPage = $this->cityPageViewRegistry->getCityPage();
        $category = $this->cityPageViewRegistry->getCategory();
        $productIds = $cityPage->getProductIds();
